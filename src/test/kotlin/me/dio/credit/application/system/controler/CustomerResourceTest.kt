...
class CustomerResourceTest {
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("ElioUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("FernandesUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("elio@teste.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "ElioUpdate",
        lastName: String = "FernandesUpdate",
